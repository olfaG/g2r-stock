...
<head>
    ...
    <title>cgu</title>
    <link rel="stylesheet" href="../../ressources/css/cgu.css">
</head>
<body>
    <div class="container">
        <h1>G2R STOCK</h1>
        <div class="row">
            <h2>CONDITION GENERAL D’UTILISATION</h2>
            <div class=" col scroll-bg">
                <div class="col scroll-div">
                    <div class=" col scroll-object">
                           ...
                           <h5> Conditions générales d'utilisation </h5>
                            ...
                            <p>
                                ...
                                g2r-stock se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes
                                CGU.
                            </p>
...
<p>
    L’édition et la direction de la publication du site g2r-stock est assurée par _______________, domicilié
    _______________.
    Numéro de téléphone est _______________
    Adresse e-mail _______________.
    La personne est assujetie au RCS avec le numéro d'inscription _______________ et son numéro de
    TVA intracommunautaire est le _______________
    L'hébergeur du site g2r-stock est la société _______________, dont le siège social est situé au
...
<p>
    Le site g2r-stock permet à l'Utilisateur un accès gratuit aux services suivants :
    ...
    la responsabilité de g2r-stock. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur
...
<p>
    ...
    Les sources des informations diffusées sur le site g2r-stock sont réputées fiables mais le site ne
    ...
    Malgré des mises à jour régulières, le site g2r-stock ne peut être tenu responsable de la modification
    ...
    2
    Le site g2r-stock ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
...
<p>
    ...
    liens, il sortira du site g2r-stock. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles
...
<p>
    ...
    l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site g2r-stock. Les cookies ne
    ...
    L’information contenue dans les cookies est utilisée pour améliorer le site g2r-stock.
...
<p>
    ...
    coordonnées inscrites à l’ARTICLE 1.
                ...
                <div class=" retour  ">
                    <form action="../p_acceuil/acceuil.php">
