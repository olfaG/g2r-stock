...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 06 sep. 2022 à 23:16
...
--
-- Structure de la table `ajout_emprunt`
--

CREATE TABLE `ajout_emprunt` (
  `id` int(10) NOT NULL,
...
--
-- Déchargement des données de la table `ajout_emprunt`
--

INSERT INTO `ajout_emprunt` (`id`, `nom`, `stag`, `emplo`, `model`, `qty`, `pret`, `retour`, `ip`, `ville`) VALUES
...
--
-- Structure de la table `ajout_stock`
--

CREATE TABLE `ajout_stock` (
  `id` int(60) NOT NULL,
...
--
-- Déchargement des données de la table `ajout_stock`
--

INSERT INTO `ajout_stock` (`id`, `modele`, `mac`, `dispo`, `etat`, `comment`, `ip`, `ville`) VALUES
(1, 'macbook pro', 'hreqgzdsfs452', 'disponible', '', '_', 'fvdsc', 'Paris 11eme'),
(2, 'hp', 'hreqgzdsfs452', 'indisponible', 'indisponible', '_', '45120lkjhgvc', 'Montreuil'),
(3, 'dell', 'hreqgzdsfs452', 'disponible', 'null', '_', 'fvdsc', 'Massy'),
(4, 'hp', 'hreqgzdsfs452', 'disponible', 'endommagé', '_', '45120lkjhgvc', 'Montreuil'),
(5, 'macbook pro', 'hreqgzdsfs452', 'indisponible', 'en reparation', '_', '45120lkjhgvc', 'Cergy'),
(6, 'macbook pro', 'hreqgzdsfs452', 'disponible', 'déjà réparé', '_', 'fvdsc', 'Le Kremlin-Bicêtre'),
(7, 'dell', 'hreqgzdsfs452', 'non disponible', 'en réparation', '_', 'hjkggl', 'Mantes-la-Jolie'),
(8, 'macbook pro', 'hreqgzdsfs452', 'non disponible', 'endommagé', 'dfghvkjblknl,!;!:,nb;nvc, bn,', 'fvdsc', 'Paris 11eme'),
(9, 'dell', 'hreqgzdsfs452', 'disponible', 'en bon etat', 'hdfgfggkjhmhiuhtdsdffykhulln:kn;nbbnn;:', 'patricia123', 'Créteil');
...
--
-- Index pour la table `ajout_emprunt`
--
ALTER TABLE `ajout_emprunt`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `ajout_stock`
--
ALTER TABLE `ajout_stock`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `ajout_emprunt`
--
ALTER TABLE `ajout_emprunt`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `ajout_stock`
--
ALTER TABLE `ajout_stock`
